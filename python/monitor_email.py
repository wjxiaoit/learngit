...
EMAIL_USER = 'b.xiao@mangofun.cn'
EMAIL_PASSWORD = 'Wj3122130!'
RECIPIENTS = ['wjxiaoit@163.com']
...
def main():
    ...
    content = render('monitor.htm', **data)
#    print(content)

    with yagmail.SMTP(user=EMAIL_USER,password=EMAIL_PASSWORD,
                      host='smtp.exmail.qq.com',port=465) as yag:
